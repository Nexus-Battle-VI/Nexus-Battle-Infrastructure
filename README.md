...
| [019](docs/adr/ADR-019-sprint-2-bounded-contexts.md) | Contextos acotados de Sprint 2: Combat, Missions, Auction y Wallet | Proposed |
| [020](docs/adr/ADR-020-realtime-combat.md) | Tiempo real para Jugar Online | Proposed |
...
de auditoría/outbox, el ciclo de vida aceptado de recursos visuales y el flujo
propuesto de `catalog.product.created` por SQS. Los de despliegue
