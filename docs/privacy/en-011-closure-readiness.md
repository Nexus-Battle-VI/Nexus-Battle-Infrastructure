...
| CA-04 | Derecho al olvido — estrategia verificable compatible con HU-43, máximo 30 días, retención solo justificada | **Estrategia/documentación cubierta por este PR.** [ADR-014 Decisión 5](../adr/ADR-014-privacy-data-governance.md#5-estrategia-de-orquestación-para-el-derecho-al-olvido-hu-43-coordinación-síncrona-por-api-sin-esperar-a-adr-006) fija la orquestación (coordinación durable por Account, progreso por contexto, plazo de 30 días, excepciones de retención documentadas). La implementación funcional queda en HU-43. |
